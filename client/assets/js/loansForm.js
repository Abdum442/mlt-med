function showLoansForm() {
  // Create the form elements dynamically
  const formContainer = document.createElement('div');
  formContainer.className = 'form-container';

  const loansForm = document.createElement('form');
  loansForm.id = 'loansForm';


  const formFields = [
    { label: 'Purpose:', type: 'text', name: 'purpose' },
    { label: 'Amount:', type: 'number', name: 'amount' },
    { label: 'Duration Days:', type: 'number', name: 'duration-days' },
    { label: 'Start Date:', type: 'date', name: 'start-date' },
    { label: 'End Date:', type: 'date', name: 'end-date' },
  ...
  formContainer.appendChild(loansForm);
...
function exitForm() {
  ...
  document.getElementById('companyLoansBtn').click();
