...
const query = 'INSERT INTO payables (description, amount, due_date, amount_left, status) VALUES ($1, $2, $3, $4, $5) RETURNING id';
...
async function addPaymentData() {
  ...
  const paymentQuery = 'INSERT INTO payments_made (payable_id, amount, payment_date) VALUES ($1, $2, $3) RETURNING id';
